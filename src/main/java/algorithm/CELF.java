...
public class CELF {
    ...
    public CELF(ArrayList<Billboard> solutionSet, ArrayList<Billboard> candidateSet) {
    ...
    public static void order(BillboardSet billboardSet, ArrayList<Billboard> candidateSet) {
